...
export default function ProductError({
  ...
  return (
    <main style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "60vh", padding: "2.5rem", textAlign: "center" }}>
      ...
      <p style={{ color: "var(--color-fg-muted)", marginBottom: "2.5rem" }}>{t("error_body")}</p>
      ...
      <Link href={i18Link("shop", locale)} style={{ color: "var(--color-fg)", textDecoration: "underline", textUnderlineOffset: "3px" }}>
        &larr; {t("back_to_shop")}
      </Link>
    </main>
  );
